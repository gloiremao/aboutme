...
$(document).ready(function(){
    ...
    $('#js-bar').appear(function() {
    	...
    	$('#php-bar').animate({width:'60%'},1500);
    	$('#sql-bar').animate({width:'65%'},1500);
    	$('#bs-bar').animate({width:'90%'},1500);
    ...
    $('#java-bar').appear(function() {
    	...
    	$('#cpp-bar').animate({width:'70%'},1500);
    	$('#java-bar').animate({width:'70%'},1500);
    	$('#cs-bar').animate({width:'50%'},1500);
    	$('#ooc-bar').animate({width:'50%'},1500);
    });

    $('#a-bar').appear(function() {
    	$('#a-bar').animate({width:'70%'},1500);
    });

    $('#ms-bar').appear(function() {
    	$('#ms-bar').animate({width:'80%'},1500);
    });
